...
Доступ по паролю ADMIN_PASSWORD. Срок подписки хранится в поле sub_until,
поэтому управление = правка sub_until: продлить / отключить подписку
у веб- и Telegram-пользователей.
"""
import functools
import hmac
import os

...
BROADCASTS = {
    "back": ("✅ Всё работает — возвращайтесь",
             "кто пользовался до поломки и ни разу после · активным"),
    "refresh": ("🔄 Обновите подписку (извинение)",
                "активным подписчикам · серверы переехали на новые адреса"),
    ...
    "paidref": ("Звёзды за оплатившего друга",
                "всем живым · звёзды вручаете вы, о каждой оплате придёт сообщение"),
    "promo":  ("Промокод", "всем живым"),
    "sale":   ("Акция", "всем живым"),
    "salemore": ("Акция стала выгоднее", "всем живым · когда увеличили бонус"),
    "salert": ("Акция для ушедших", "у кого подписка закончилась · нужна активная акция"),
}
